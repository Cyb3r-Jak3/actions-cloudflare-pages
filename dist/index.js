...
exports.create_deployment = exports.check_auth = void 0;
...
function create_deployment(config) {
    return __awaiter(this, void 0, void 0, function* () {
        core.debug('Starting deployment');
        let res;
        try {
            res = yield config.instance.post(`accounts/${config.account_id}/pages/projects/${config.project_name}/deployments`);
        }
        catch (error) {
...
exports.create_deployment = create_deployment;
...
function create_config() {
    ...
    const request_instance = axios_1.default.create({
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            core.endGroup();
            yield cloudflare.create_deployment(config);
        }
        catch (error) {
